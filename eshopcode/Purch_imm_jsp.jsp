...
<jsp:useBean id="dcon" scope="session" class="dbean.DBCon" />
 ...
 <%
	...
	Statement st=con.createStatement();
        ResultSet rs=st.executeQuery("select * from prod_det where present_stock=0");
 ...
 <head><FONT  face="comic sans ms" size=3 COLOR=#006600><center><hr color=#99CC00>Items To Be Purchase Immediately<hr color=#99CC00></center></font></head> 
  </body> 
