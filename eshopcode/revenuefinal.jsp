...
<jsp:useBean id="dcon" scope="session" class="dbean.DBCon" />
 ...
 <%
	...
	String date2=day2+"-"+mon2+"-"+yr2;
      ...
      ResultSet rs=st.executeQuery("select p_code,p_name,sum(p_price) sum from sales_det where p_code='"+pcode+"' and s_date between '"+date1+"' and '"+date2+"' group by p_code,p_name");
