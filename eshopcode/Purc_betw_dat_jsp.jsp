...
<jsp:useBean id="dcon" scope="session" class="dbean.DBCon" />
 ...
 <%
	...
	String date2=day2+"-"+mon2+"-"+yr2;
        ...
        ResultSet rs=st.executeQuery("select  p_code,p_name,p_qty,p_price,to_char(pursc_date,'dd-mon-yy') dd from purchase_det where pursc_date between to_date('"+date1+"','DD-MON-YY') and to_date('"+date2+"','DD-MON-YY')");
         %> 
